...
Prefer `scripts/arx5/convert_to_lerobot.py three_tasks` for new workflows.
"""
...
OUTPUT_DIR = PROFILES["three_tasks"].output_dir
REPO_ID = PROFILES["three_tasks"].repo_id
TASK_SOURCES = tuple((source.name, source.directory, source.limit) for source in PROFILES["three_tasks"].sources)
