...
import openpi.policies.arx5_policy as arx5_policy
...
_CONFIGS = [
    ...
    # LoRA variant of the ARX5 configuration above. Only LoRA adapters are trainable; the base
    # pi0.5 parameters stay frozen. EMA is disabled because it is not supported for LoRA fine-tuning.
    TrainConfig(
    ...
    TrainConfig(
        name="pi05_arx5_pick_bread_mango_bottle_lora",
        model=pi0_config.Pi0Config(
            pi05=True,
            action_horizon=50,
            discrete_state_input=False,
    ...
    TrainConfig(
        name="pi05_arx5_pick_six_tasks_lora",
        model=pi0_config.Pi0Config(
            pi05=True,
            action_horizon=50,
            discrete_state_input=False,
